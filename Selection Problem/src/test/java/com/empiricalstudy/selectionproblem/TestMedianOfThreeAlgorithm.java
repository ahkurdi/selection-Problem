...
public class TestMedianOfThreeAlgorithm implements SelectionAlgorithmTestTemplate {

    public static ElementWithSelectedRank elementWithSelectedRank = new ElementWithSelectedRankMedianOfThreeAlgorithm();
    ...
    public void testSortedData() {
        ...
        int elementAtSelectedRank = elementWithSelectedRank.findElementAtSelectedRank(Util.copyArray(sortedList), rank);
    ...
    public void testSimiSortedData() {
        int[] simiSortedList = Util.getSimiSortedList(1, 1000, 50);
        int rank = 22;

        Util.print(simiSortedList);

        int elementAtSelectedRank = elementWithSelectedRank.findElementAtSelectedRank(Util.copyArray(simiSortedList), rank);
    ...
    public void testRandomData() {
        int[] randomSortedList = Util.getRandomList(50, 10000, 1000);
        int rank = 1000;

        Util.print(randomSortedList);

        int elementAtSelectedRank = elementWithSelectedRank.findElementAtSelectedRank(Util.copyArray(randomSortedList), rank);
        ...
        int[] randomList2 = Util.getRandomList(1000, 100000, 1000);
        int rank2 = 100;

        int elementAtSelectedRank2 = elementWithSelectedRank.findElementAtSelectedRank(Util.copyArray(randomList2), rank2);
    ...
    public void testReversedData() {
        int[] simiSortedList = Util.getSortedReversedList(50, 505450, 1650);
        int rank = 1;
